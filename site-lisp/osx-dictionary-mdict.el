...
(defconst osx-dictionary-cli-mfile "osx-dictionary.m"
  "The name of executable file compiled from.")
...
(defun osx-dictionary-recompile ()
  ...
  (let ((default-directory osx-dictionary--load-dir))
    (shell-command (concat "clang -O3 -framework CoreServices -framework Foundation" osx-dictionary-cli-mfile " -o "
